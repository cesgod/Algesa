        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="indexc.php" class="site_title"><img src="images/1logo.png"></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="indexc.php">Dashboard</a></li>
            ...
            <div class="dashboard_graph">
                ...
                <div class="x_title">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="../../../../virtualenvs/Cl/soapclient/perfil_carga.php" method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                           ...
                           <select class="form-control"  title="meterid" name="meterid">
                          ...
                          <?php
                            ...
                            $query="SELECT * FROM potencia WHERE MeterID = '".$_SESSION['username']."' ORDER BY Meter";
                            $res=mysqli_query($conexion,$query);
                            while($row = mysqli_fetch_array($res)){
                                $medidores=$row['Meter'];
                                echo "<option>".$medidores."</option>";
                            }
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input name="date_a" id="date_a" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input name="date_b" id="date_b" class="date-picker form-control" placeholder="dd-mm-yyyy" type="text" required="required" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                          <script>
